...
$consultaNews = $conn->query("SELECT * FROM NEWS ORDER BY new_date ASC limit 3");
          ...
          echo '
            <div class="col-lg-4 col-md-6 shuffle-item">
              <div class="project-item">
                <img src="'. $proyecto['thumbnail'] . '" alt="project-image" class="img-fluid w-100">
                <div class="project-hover bg-secondary px-4 py-3">
                  <a href="#" class="text-white h4">' . $proyecto["title"] .'</a>
