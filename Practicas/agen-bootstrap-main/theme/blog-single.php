...
$consultaNewId = $conn->query("SELECT * FROM NEWS WHERE id = " . $_GET['id']);

//esto devolverá un array con los datos de la noticia (asociativo!!, de un solo registro)
$newId = $consultaNewId->fetch_assoc();
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <h3 class="font-tertiary mb-5"><?= $newId['title'] ?></h3>
        <img src="<?= $newId['thumbmail'] ?>" alt="<?= $newId['title'] ?>" class="img-fluid w-100 mb-3">
        <p><?= $newId['new_date'] ?></p>
        <div class="content">
          <p>
            <?= $newId['description'] ?>
